...
(function(root, factory) {
  if (typeof exports === "object" && typeof module === "object") {
    ...
    exports["imageFit"] = factory();
  } else {
    root["imageFit"] = factory();
  }
})(this, function() {
  return (function($) {
    "use strict";
    ...
    var _funcs = [],
      ...
      _objFit =
        typeof window.document.createElement("div").style.objectFit !==
        "undefined", // check object-fit support
      // default options
      _defaults = {
        /*
        ...
        container: function() {
          ...
          while (e.nodeType !== 9) {
            // stop at document
            if (
              (" " + e.className + " ").indexOf(" image-fit-container ") > -1
            ) {
              r = e;
              break;
            }
        ...
        checkAndSet: function(opts) {
          ...
          var aspectRatio = opts.img.clientHeight / opts.img.clientWidth * 100,
            containerAspectRatio =
              opts.container.clientHeight / opts.container.clientWidth * 100,
            imageType =
